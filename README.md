...
| 🔍[`WildFires-LosAngeles-Jan-2025`](#) [![image]()](#) 2,685.88 sq, km = 1,148,351 buildings processed, 10,133 with damage found (1-7 observation each) - 108 datacubes, more processing. | 🔍[`HurricaneHelene-Oct24`](#) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](#) training the models 🔥 |
...
built by 🌀 [`blue_options-4.200.1`](https://github.com/kamangir/awesome-bash-cli), based on 🧑🏽‍🚒 [`palisades-4.294.1`](https://github.com/kamangir/palisades).
