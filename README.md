...
palisades \
	analytics \
	ingest \
	[acq_count=<-1>,building_count=<-1>,damage=<-1.0>,dryrun,upload] \
	[-|<object-name>]
 . ingest analytics.
palisades \
	analytics \
...
built by 🌀 [`blue_options-4.197.1`](https://github.com/kamangir/awesome-bash-cli), based on 🧑🏽‍🚒 [`palisades-4.214.1`](https://github.com/kamangir/palisades).
