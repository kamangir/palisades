...
|   |   |
| --- | --- |
| 🧑🏽‍🚒[`Maxar Open Data`](#) [![image]()](#)  | 🧑🏽‍🚒[`Step by Step Review`](#) [![image]()](#)  |
...
built by 🌀 [`blue_options-4.192.1`](https://github.com/kamangir/awesome-bash-cli), based on 🧑🏽‍🚒 [`palisades-4.3.1`](https://github.com/kamangir/palisades).
